...
test.describe("Quiz_Feuerwehrauto.vue", () => {
  test.beforeEach(async ({ page }) => {
    // Passe ggf. den Pfad an, falls deine Route anders ist
    await page.goto("http://localhost:4321/LoeschZwerge/quiz/feuerwehrauto");
  });

  test("Quiz Template zeigt korrekten Titel und Beschreibung", async ({
    page,
  }) => {
  ...
  test("Fragen des Feuerwehrauto-Quiz werden angezeigt", async ({ page }) => {
