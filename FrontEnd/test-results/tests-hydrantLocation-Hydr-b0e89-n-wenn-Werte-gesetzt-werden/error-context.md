...
- Name: HydrantLocation.vue >> Zielspot wird grün hervorgehoben, wenn Werte gesetzt werden
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\hydrantLocation.spec.js:27:3
...
Call log:
  - waiting for locator('.hydrantenschild input').nth(7)

    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\hydrantLocation.spec.js:37:23
```
