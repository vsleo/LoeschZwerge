...
- Name: Header.vue >> Alle Navigationslinks sind sichtbar
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\header.spec.js:17:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('header nav a:has-text("Feuerwehrauto")') resolved to 2 elements:
    1) <a class="" href="/LoeschZwerge/car"> Feuerwehrauto</a> aka getByRole('link', { name: 'Feuerwehrauto' }).first()
    2) <a class="" href="/LoeschZwerge/car"> Feuerwehrauto</a> aka getByRole('link', { name: 'Feuerwehrauto' }).nth(1)

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('header nav a:has-text("Feuerwehrauto")')

    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\header.spec.js:27:29
```
