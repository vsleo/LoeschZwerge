...
- Name: Quiz_Template.vue >> Weiter-Button erscheint nach Auswahl
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizTemplate.spec.js:29:3
...
Call log:
  - waiting for locator('.option-button').first()
    ...
    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizTemplate.spec.js:31:26
```
