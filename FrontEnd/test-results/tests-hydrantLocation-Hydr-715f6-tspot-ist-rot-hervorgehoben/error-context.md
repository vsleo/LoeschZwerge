...
- Name: HydrantLocation.vue >> Der Startspot ist rot hervorgehoben
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\hydrantLocation.spec.js:15:3
...
Locator: locator('.hotspot-div.highlighted')
Expected: 1
Received: 0
Call log:
  - expect.toHaveCount with timeout 5000ms
  - waiting for locator('.hotspot-div.highlighted')
    9 × locator resolved to 0 elements
      - unexpected value "0"

    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\hydrantLocation.spec.js:17:31
```
