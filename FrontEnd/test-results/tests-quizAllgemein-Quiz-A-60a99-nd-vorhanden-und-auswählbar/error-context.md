...
- Name: Quiz_Allgemein.vue >> Antwortmöglichkeiten sind vorhanden und auswählbar
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizAllgemein.spec.js:28:3
...
Call log:
  ...
  - waiting for locator('.quiz-answer, .answer, [data-testid="quiz-answer"]').first()
    ...
    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizAllgemein.spec.js:35:35
```
