...
- Name: Quiz_Feuerwehrauto.vue >> Nach Auswahl einer Antwort erscheint ein Weiter-Button
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizFeuerwehrauto.spec.js:41:3
...
Call log:
  - waiting for locator('.quiz-answer, .answer, [data-testid="quiz-answer"]').first()
    ...
    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizFeuerwehrauto.spec.js:47:27
```
