...
- Name: Header.vue >> Logo ist sichtbar und verlinkt zur Startseite
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\header.spec.js:8:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('header .headline a img') resolved to 2 elements:
...
Call log:
  ...
  - waiting for locator('header .headline a img')

    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\header.spec.js:10:24
```
