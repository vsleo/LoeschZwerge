...
- Name: Quiz_Template.vue >> Quiz kann durchgeklickt werden und zeigt Ergebnis
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizTemplate.spec.js:35:3
...
Locator: locator('.result-box')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('.result-box')

    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizTemplate.spec.js:47:47
```
