...
- Name: Quiz_Template.vue >> Antwort kann ausgewählt werden und wird farblich markiert
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizTemplate.spec.js:17:3
...
Call log:
  - waiting for locator('.option-button').first()

    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\quizTemplate.spec.js:21:26
```
