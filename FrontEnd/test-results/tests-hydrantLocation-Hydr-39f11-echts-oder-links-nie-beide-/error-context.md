...
- Name: HydrantLocation.vue >> Tooltip zeigt nur eine Richtung (rechts oder links, nie beide)
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\hydrantLocation.spec.js:46:3
...
Call log:
  - waiting for locator('.hotspot-div.highlighted')
    ...
    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\hydrantLocation.spec.js:51:46
```
