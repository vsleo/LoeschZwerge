...
- Name: HydrantenschildKomponente.vue >> Die berechneten Werte werden angezeigt
- Location: C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\hydrantschild.spec.js:59:3

# Error details

```
Error: expect.toContainText: Error: strict mode violation: locator('div') resolved to 36 elements:
    1) <div data-v-9145966c="" class="hydrantenschild">…</div> aka locator('astro-island div').first()
    2) <div data-v-9145966c="">1</div> aka getByText('1', { exact: true })
    3) <div data-v-9145966c="">123 NaN 78.9 12.3</div> aka getByText('NaN 78.9 12.3')
    4) <div data-hidden="" id="dev-toolbar-root" data-placement="bottom-center">…</div> aka locator('#dev-toolbar-root')
    5) <div id="dev-bar-hitbox-above"></div> aka locator('#dev-bar-hitbox-above')
    6) <div id="dev-bar">…</div> aka locator('#dev-bar')
    7) <div id="bar-container">…</div> aka getByText('Menu Inspect Audit Settings')
    8) <div class="icon">…</div> aka getByRole('button', { name: 'Menu' })
    9) <div class="notification"></div> aka getByRole('button', { name: 'Menu' })
    10) <div class="icon">…</div> aka getByRole('button', { name: 'Inspect' })
    ...
...
Call log:
  ...
  - waiting for locator('div')
    ...
    at C:\Users\erwin\IdeaProjects\LoeschZwerge\FrontEnd\tests\hydrantschild.spec.js:78:39
```
