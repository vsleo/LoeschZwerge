  ...
  <div class="body">
    ...
    <div class="wrapper content-section">
      <div class="box">
        ...
        <p>
          Weißt du schon, was alles auf einem Einsatzfahrzeug verladen ist? Mit dem <a href="/LoeschZwerge/car">interaktiven Feuerwehrauto</a> kannst du dir einen Einblick verschaffen.
        </p>
      </div>
    ...
    <div class="wrapper content-section">
      ...
      <div class="box">
        ...
        <p>
          Hier kannst du dein Wissen auf die Probe stellen! Bei unseren <a href="/LoeschZwerge/quiz">Quizzes</a> werden interessante Fragen zur Feuerwehr gestellt. Kannst du sie richtig beantworten?
        </p>
      </div>
    </div>
    ...
    <div class="wrapper content-section">
      ...
      <div class="box">
        <h4 class="box-heading">Brandschutz</h4>
        <p>
          Spannende Videos zum Thema Feuerwehr findest du <a href="/LoeschZwerge/brandschutz">hier</a>.
        </p>
      </div>
