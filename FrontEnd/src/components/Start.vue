    ...
    <div class="wrapper">
      <div>
        <p class="paragraph" style="text-align: center" ;>
          Was genau ist die Feuerwehr? Und was macht sie überhaupt? Bei den
          Löschzwergen lernst du mit Spiel und Spaß alles rund ums
          Feuerwehrauto!
        </p>
      </div>
    </div>
    <div class="wrapper">
      <div class="box">
        ...
        <p class="paragraph">
          ...
          steht Menschenrettung immer an erster Stelle.
        </p>
      </div>
      <div>
